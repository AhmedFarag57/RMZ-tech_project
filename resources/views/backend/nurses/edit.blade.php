...
9 KB
Storage used
9 KBOwned by Pharos University in Alexandria
Location
samir
Owner
Ahmed AbdElrahman
...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Create Nurse</h2>
            </div>
            <div class="flex flex-wrap items-center">
                <a href="{{ route('nurses.index') }}" class="bg-gray-200 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
        ...
        <div class="table w-full mt-8 bg-white rounded">
            ...
            <form action="{{ route('nurses.store') }}" method="POST" class="w-full max-w-xl px-6 py-12" enctype="multipart/form-data">
                @csrf
